...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"getUser\": () => (/* binding */ getUser)\n/* harmony export */ });\n/* harmony import */ var _configs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../configs */ \"./src/configs/index.js\");\n/* harmony import */ var _resetInputSignUp__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./resetInputSignUp */ \"./src/helpers/resetInputSignUp.js\");\n\r\n\r\n\r\nconst getUser = async user => {\r\n\tconst response = await fetch(`${_configs__WEBPACK_IMPORTED_MODULE_0__.apiHost}/user/${user.login}`, {\r\n\t\tmethod: 'POST',\r\n\t\theaders: {\r\n\t\t\t'Content-Type': 'application/json'\r\n\t\t},\r\n\t\tbody: JSON.stringify(user)\r\n\t})\r\n\tif (response.status === 201) {\r\n\t\t(0,_resetInputSignUp__WEBPACK_IMPORTED_MODULE_1__.resetInputSignUp)()\r\n\r\n\t\tdocument.getElementsByTagName('sign-up')[0].remove()\r\n\t}\r\n}\n\n//# sourceURL=webpack://create-signin-signup/./src/helpers/getUser.js?");
